...
import elderlyImg from '../assets/personas/elderly.png'
import childImg from '../assets/personas/child.png'
import workingWomanImg from '../assets/personas/workingwoman.png'
        ...
        <div className="landing-section-inner">
          ...
          <div className="persona-grid">
            <div className="persona-card">
              <img src={elderlyImg} alt="Illustration representing an elderly resident" className="persona-portrait" />
            ...
            <div className="persona-card">
              <img src={childImg} alt="Illustration representing a school-going child" className="persona-portrait" />
            ...
            <div className="persona-card">
              <img src={workingWomanImg} alt="Illustration representing a working mother" className="persona-portrait" />
